<%@ Page Language="C#" MasterPageFile="~/WAD.Master" AutoEventWireup="true" CodeBehind="ArtWorkDetails.aspx.cs" Inherits="HCI_Assignment.ArtWorks.ArtWorkDetails" %>
...
<asp:Content ID="ArtWorkDetails" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="details-container">
        ...
        <div>
            <asp:ImageButton ID="detailsLoveBtn" runat="server" AlternateText="Add to WishList" title="Add to Wishlist" ImageUrl="img/wishlist/heart-icon-inactive.png" CssClass="cancel-btn" CommandArgument='<%# Eval("ArtId")%>' CommandName="addtowishlist" OnClick="loveBtn_Click" />
