<%@ Page Language="C#" MasterPageFile="~/WAD.Master" AutoEventWireup="true" CodeBehind="ArtWorks.aspx.cs" Inherits="HCI_Assignment.ArtWorks.ArtWorks" %>
        ...
        <div class="dlImg">
            ...
            <asp:DataList ID="ArtWorkDataList" runat="server" DataKeyField="ArtId" RepeatColumns="3" RepeatDirection="Horizontal" CellSpacing="35" HorizontalAlign="Center" CellPadding="3" OnItemCommand="ArtWorkDataList_ItemCommand">
                <ItemTemplate>
                    ...
                    <asp:ImageButton ID="loveBtn" runat="server" AlternateText="Add to WishList" title="Add to Wishlist" OnClick="loveBtn_Click" ImageUrl="img/wishlist/heart-icon-inactive.png" ImageAlign="right" CssClass="love-btn" CommandArgument='<%# Eval("ArtId")%>' CommandName="addtowishlist" />
                    <br /><br />
                </ItemTemplate>
            </asp:DataList>
